-- =============================================
-- System Ewidencji Personelu - MySQL
...
CREATE TABLE departments (
    ...
    budget_yearly   DECIMAL(12, 2) DEFAULT 0,
...
CREATE TABLE contracts (
    ...
    contract_type   ENUM('umowa o pracę', 'umowa zlecenie', 'umowa o dzieło', 'B2B') NOT NULL,
    start_date      DATE NOT NULL,
    end_date        DATE,
    working_hours   INT DEFAULT 40,
    probation_end   DATE,
    status          ENUM('active', 'suspended', 'terminated', 'expired') DEFAULT 'active',
...
CREATE TABLE leave_requests (
    id              INT AUTO_INCREMENT PRIMARY KEY,
    employee_id     INT NOT NULL,
    leave_type      ENUM('wypoczynkowy', 'na żądanie', 'macierzyński', 'ojcowski', 'okolicznościowy', 'bezpłatny', 'chorobowy') NOT NULL,
    start_date      DATE NOT NULL,
    ...
    INDEX idx_emp_date (employee_id, start_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE evaluations (
    ...
    score_technical     TINYINT CHECK (score_technical BETWEEN 1 AND 5),
    score_leadership    TINYINT CHECK (score_leadership BETWEEN 1 AND 5),
    score_communication TINYINT CHECK (score_communication BETWEEN 1 AND 5),
    score_teamwork      TINYINT CHECK (score_teamwork BETWEEN 1 AND 5),
    score_initiative    TINYINT CHECK (score_initiative BETWEEN 1 AND 5),
    overall         DECIMAL(2, 1),
    comments        TEXT,
...
(1, 1, 1,    'K8S-2025-001'), (1, 6, 1,    'K8S-2025-002'), (1, 9, 1,    'K8S-2025-003'),
(2, 1, 1,    'BHP-2025-001'), (2, 2, 1,    'BHP-2025-002'), (2, 3, 1,    'BHP-2025-003'), (2, 4, 1,    'BHP-2025-004'), (2, 5, 1,    'BHP-2025-005'),
(3, 2, 1,    'RODO-2025-001'), (3, 7, 1,   'RODO-2025-002'),
(4, 6, NULL, NULL), (4, 9, NULL, NULL),
(5, 1, 1,    'LDR-2025-001'), (5, 2, 1,    'LDR-2025-002'), (5, 3, 1,    'LDR-2025-003'), (5, 4, 1,    'LDR-2025-004'), (5, 5, 1,    'LDR-2025-005'),
